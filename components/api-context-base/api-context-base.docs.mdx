...
Exports:  
1. `ApiContextBase` - the provider end of the api context. Takes in an axios instance with your baseUrl (and any other parameters required for all api calls using the context)
...
app.js
    ...
    import { ApiContextProvider } from '@learn-bit-react/context.api-context-base';
